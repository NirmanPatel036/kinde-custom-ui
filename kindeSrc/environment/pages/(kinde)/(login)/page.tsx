...
export default async function Page(event: KindePageEvent): Promise<string> {
    const heading =
        (event as any)?.context?.widget?.content?.heading ?? "Welcome back";
...
<p class="auth-subheading">Enter your credentials to access your exam dashboard</p>
...
<div id="notice-instructor" class="role-notice role-notice--instructor">
  <span>Instructor accounts require approval. Contact your institution admin if you need access.</span>
</div>
<div id="notice-admin" class="role-notice role-notice--admin">
  <span>Admin sign-in is restricted to authorized personnel only.</span>
</div>

<!-- Email Form -->
<form method="POST" id="auth-form" autocomplete="on">
...
<div class="auth-socials">
  <button class="social-btn" type="button" aria-label="Continue with Google">
  ...
  <button class="social-btn" type="button" aria-label="Continue with Apple">
  ...
  <button class="social-btn" type="button" aria-label="Continue with Microsoft">
    <svg width="20" height="20" viewBox="0 0 24 24">
...
<p class="auth-footer-text">No account? <a href="/register">Create one</a></p>
